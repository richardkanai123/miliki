...
const AddUnitForm = ({ propertyId, slug }: AddUnitFormProps) => {
    ...
    return (
        <form id="create-unit-form" onSubmit={form.handleSubmit(handleSubmit)} className="w-full max-w-7xl mx-auto">
            <div className="grid gap-6 lg:grid-cols-12">

                {/* Header Section (Mobile only or Full width top) */}
                <div className="lg:col-span-12 space-y-1 mb-2">
                    <h1 className="text-2xl font-bold tracking-tight">Add New Unit</h1>
                    <p className="text-muted-foreground">Fill in the details below to add a new unit to this property.</p>
                </div>
